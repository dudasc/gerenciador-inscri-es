...
$data = $dao->consultaAlunosMinicurso((int)$_GET['cd']);
$linha = mysql_fetch_array($data);

$pdf->SetFont('Arial', 'B', 12);
$pdf->Cell(null,6,'Dados do mini-curso', 1, null, 'C' );
$pdf->Ln();
$pdf->Cell(40,6,'Nome:', 1);
$pdf->SetFont(null, '', null);
$pdf->Cell(null,6,iconv('utf-8','iso-8859-1', $linha['nome_minicurso']), 1);
$pdf->Ln();
$pdf->SetFont('Arial', 'B', 12);
$pdf->Cell(40,6,iconv('utf-8','iso-8859-1', 'Responsável'), 1);
$pdf->SetFont(null, '', null);
$pdf->Cell(null,6,iconv('utf-8','iso-8859-1', $linha['responsavel']), 1);
$pdf->Ln();
...
$pdf->Cell(30, 12, 'Lista de alunos', 0, 0, 'C');//'Pessoas' centralizado no meio da página
$pdf->Ln(12);
...
$pdf->Cell(80, 10, 'Assinatura', 1);
$pdf->Ln();

$pdf->SetFont('Arial', '', 11);
//POPULANDO A TABELA
$data2 = $dao->consultaAlunosMinicurso((int)$_GET['cd']);
//print_r($linha);
...
$pdf->Ln(150);
$pdf->Output("relatorio-".$linha['nome_minicurso'].".pdf","I");
}else{
